...
var MaskAnnotateView = View.extend({
  events: {
  ...
  initialize: function (settings) {
    console.log("MaskAnnotateView init");
  ...
  render: function () {
    ...
    console.log("MaskAnnotateView render");
    ...
    this.StackWidget = new SAM.GirderStackWidget($(this.el), this.viewer, this.viewer_overlay, apiRoot);
